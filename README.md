...
เมื่อได้รับข้อความ "/studentID command argument" ให้นักศึกษาที่มี studentID ตรงกับค่าในข้อความทำการตาม command ที่ระบุในข้อความ โดย command มีได้เพิ่มอีก 3 แบบ ได้แก่
