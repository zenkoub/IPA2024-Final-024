...
## โจทย์ส่วน 1 (10 คะแนน) คล้ายกับ โจทย์ข้อสอบ NPA2023 Final มีเปลี่ยนแปลงเล็กน้อย (ห้ามใช้ Hardcode token ลงในโปรแกรม ให้ใช้ Environment variable เก็บ Token) ให้นักศึกษาทำโจทย์ข้อ 1 ให้เสร็จก่อน จึงทำโจทย์ข้อ 2 
